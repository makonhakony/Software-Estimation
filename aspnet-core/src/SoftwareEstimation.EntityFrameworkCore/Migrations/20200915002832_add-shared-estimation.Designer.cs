...
namespace SoftwareEstimation.Migrations
{
    ...
    [Migration("20200915002832_add-shared-estimation")]
    partial class addsharedestimation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SoftwareEstimation.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SoftwareEstimation.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SoftwareEstimation.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SoftwareEstimation.Plans.HistoEstimation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("AppHistoricalEstimation");
                });
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("SoftwareEstimation.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("SoftwareEstimation.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("SoftwareEstimation.Authorization.Roles.Role", b =>
                {
                    b.HasOne("SoftwareEstimation.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("SoftwareEstimation.Authorization.Users.User", "DeleterUser")
                        .WithMany()
