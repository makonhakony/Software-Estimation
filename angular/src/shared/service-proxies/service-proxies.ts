...
export class HistoEstimationServiceProxy {
     ...
     * @return Success
     */
    getAveragePf(type: string | null | undefined, id: string[] | null | undefined): Observable<number> {
    ...
    protected processGetAveragePf(response: HttpResponseBase): Observable<number> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    /**
     * @param histo (optional) 
     * @return Success
     */
    update(histo: HistoDto | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/HistoEstimation/Update";
        url_ = url_.replace(/[?&]$/, "");

        const content_ = JSON.stringify(histo);
     ...
     * @return Success
     */
    getListHistoByType(type: string | null | undefined): Observable<ListResultDtoOfHistoListType> {
        let url_ = this.baseUrl + "/api/services/app/HistoEstimation/GetListHistoByType?";
        if (type !== undefined)
            url_ += "type=" + encodeURIComponent("" + type) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetListHistoByType(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetListHistoByType(<any>response_);
                } catch (e) {
                    return <Observable<ListResultDtoOfHistoListType>><any>_observableThrow(e);
                }
            } else
                return <Observable<ListResultDtoOfHistoListType>><any>_observableThrow(response_);
        }));
    }

    protected processGetListHistoByType(response: HttpResponseBase): Observable<ListResultDtoOfHistoListType> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ListResultDtoOfHistoListType.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ListResultDtoOfHistoListType>(<any>null);
    }
}
...
export class PlanServiceProxy {
     ...
     * @return Success
     */
    createPlans(plans: PlanInput | null | undefined): Observable<string> {
    ...
    protected processCreatePlans(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getListPlan(): Observable<ListResultDtoOfPlanListDto> {
        let url_ = this.baseUrl + "/api/services/app/Plan/GetListPlan";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetListPlan(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetListPlan(<any>response_);
                } catch (e) {
    ...
    protected processGetListPlan(response: HttpResponseBase): Observable<ListResultDtoOfPlanListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getPlanDetail(planId: string | null | undefined): Observable<PlanDetailOutput> {
        let url_ = this.baseUrl + "/api/services/app/Plan/GetPlanDetail?";
        if (planId !== undefined)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetPlanDetail(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetPlanDetail(<any>response_);
                } catch (e) {
                    return <Observable<PlanDetailOutput>><any>_observableThrow(e);
                }
            } else
                return <Observable<PlanDetailOutput>><any>_observableThrow(response_);
        }));
    }

    protected processGetPlanDetail(response: HttpResponseBase): Observable<PlanDetailOutput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PlanDetailOutput.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PlanDetailOutput>(<any>null);
    }
...
export class ProjectServiceProxy {
    ...
    createWithLink(projects: ProjectInput | null | undefined): Observable<string> {
        ...
        const content_ = JSON.stringify(projects);
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateWithLink(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
     ...
     * @return Success
     */
    getListProject(): Observable<ListResultDtoOfProjectListDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ListResultDtoOfProjectListDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ListResultDtoOfProjectListDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetListProject(response: HttpResponseBase): Observable<ListResultDtoOfProjectListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ListResultDtoOfProjectListDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ListResultDtoOfProjectListDto>(<any>null);
    }
     ...
     * @return Success
     */
    getProjectDetail(id: string | null | undefined): Observable<ProjectDetailOutput> {
        let url_ = this.baseUrl + "/api/services/app/Project/GetProjectDetail?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetProjectDetail(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetProjectDetail(<any>response_);
                } catch (e) {
                    return <Observable<ProjectDetailOutput>><any>_observableThrow(e);
                }
            } else
                return <Observable<ProjectDetailOutput>><any>_observableThrow(response_);
        }));
    }

    protected processGetProjectDetail(response: HttpResponseBase): Observable<ProjectDetailOutput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ProjectDetailOutput.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ProjectDetailOutput>(<any>null);
    }
    ...
    getUserID(): Observable<number> {
        let url_ = this.baseUrl + "/api/services/app/Project/GetUserID";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetUserID(response: HttpResponseBase): Observable<number> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    modifySizeValue(id: string | null | undefined, size: number | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Project/ModifySizeValue?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        if (size !== undefined)
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processModifySizeValue(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processModifySizeValue(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processModifySizeValue(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class HistoDto implements IHistoDto {
    title: string | undefined;
    description: string | undefined;
    type: string | undefined;
    time: number | undefined;
    ...
    static fromJS(data: any): HistoDto {
        data = typeof data === 'object' ? data : {};
        let result = new HistoDto();
        result.init(data);
        return result;
    }
...
export class ListResultDtoOfHistoListType implements IListResultDtoOfHistoListType {
    items: HistoListType[] | undefined;

    constructor(data?: IListResultDtoOfHistoListType) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items.push(HistoListType.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ListResultDtoOfHistoListType {
        data = typeof data === 'object' ? data : {};
        let result = new ListResultDtoOfHistoListType();
        result.init(data);
        return result;
    }
    ...
    clone(): ListResultDtoOfHistoListType {
        const json = this.toJSON();
        let result = new ListResultDtoOfHistoListType();
        result.init(json);
        return result;
...
export interface IListResultDtoOfHistoListType {
    items: HistoListType[] | undefined;
}

export class HistoListType implements IHistoListType {
    title: string | undefined;
    isDeleted: boolean | undefined;
    deleterUserId: number | undefined;
    deletionTime: moment.Moment | undefined;
    ...
    constructor(data?: IHistoListType) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): HistoListType {
        data = typeof data === 'object' ? data : {};
        let result = new HistoListType();
        result.init(data);
        return result;
    }
...
export interface IHistoListType {
    title: string | undefined;
    isDeleted: boolean | undefined;
    deleterUserId: number | undefined;
    deletionTime: moment.Moment | undefined;
...
export class UCPoint implements IUCPoint {
    ...
    t8: number | undefined;
    t9: number | undefined;
    t10: number | undefined;
    t11: number | undefined;
    t12: number | undefined;
    e0: number | undefined;
    e1: number | undefined;
    e2: number | undefined;
    e3: number | undefined;
    ...
    static fromJS(data: any): UCPoint {
        data = typeof data === 'object' ? data : {};
        let result = new UCPoint();
        result.init(data);
        return result;
    }
...
export class PlanDetailOutput implements IPlanDetailOutput {
    ...
    static fromJS(data: any): PlanDetailOutput {
        data = typeof data === 'object' ? data : {};
        let result = new PlanDetailOutput();
        result.init(data);
        return result;
    }
...
export interface IPlanDetailOutput {
    title: string | undefined;
    description: string | undefined;
    ucp: UCPoint[] | undefined;
    fp: FPoint[] | undefined;
...
export class ListResultDtoOfProjectListDto implements IListResultDtoOfProjectListDto {
    items: ProjectListDto[] | undefined;

    constructor(data?: IListResultDtoOfProjectListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ListResultDtoOfProjectListDto {
        data = typeof data === 'object' ? data : {};
        let result = new ListResultDtoOfProjectListDto();
        result.init(data);
        return result;
    }
    ...
    clone(): ListResultDtoOfProjectListDto {
        const json = this.toJSON();
        let result = new ListResultDtoOfProjectListDto();
        result.init(json);
        return result;
...
export interface IListResultDtoOfProjectListDto {
    items: ProjectListDto[] | undefined;
}
...
export class ProjectDetailOutput implements IProjectDetailOutput {
    title: string | undefined;
    type: string | undefined;
    linkURL: string | undefined;
    ...
    constructor(data?: IProjectDetailOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ProjectDetailOutput {
        data = typeof data === 'object' ? data : {};
        let result = new ProjectDetailOutput();
        result.init(data);
        return result;
    }
...
export interface IProjectDetailOutput {
    title: string | undefined;
    type: string | undefined;
    linkURL: string | undefined;
    isReady: string | undefined;
